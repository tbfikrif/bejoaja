   ...
   // private TextView currentSec;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // currentSec.setText(String.valueOf(0));
        ...
        youtubePlayerView.initializeWithCustomURL("JO6_05IxI7c", params, new YoutubePlayerView.YouTubeListener() {
        ...
        youtubePlayerView2.initializeWithCustomURL("8r9Xv1I7lgE", params, new YoutubePlayerView.YouTubeListener() {
